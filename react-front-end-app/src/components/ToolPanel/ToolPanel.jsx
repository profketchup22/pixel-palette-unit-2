    ...
    <div className="tool-panel">
      ...
      <div className="tool-section">
        ...
        <input
          ...
          value={
            props.brushSize
          } /*connects the slider to state so it shows the current value */
          onChange={(e) =>
            props.setBrushSize(e.target.value)
          } /*every time the slider move the e.target.value gets passed to canvaspage by calling props.setBrushSize */
      ...
      {props.currentUser ? (
        <div className="tool-section save-section">
          ...
          {props.saveMessage && (
            <p className="save-message">{props.saveMessage}</p>
          )}
        </div>
      ) : (
        <div className="tool-section">
