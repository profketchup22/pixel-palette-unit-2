...
function Gallery({ currentUser, setEditingArtwork }) { // receives currentUser and setEditingArtwork as props from App.jsx
    ...
    async function handleDelete(id) {
        const confirmed = window.confirm('Are you sure you want to delete this piece? This cannot be undone.') // asks before deleting
        if (!confirmed) return
    ...
    return (
        <div className="gallery-page">
            <div className="gallery-card">
                ...
                {errorMessage && <p className="gallery-empty-message">{errorMessage}</p>}
                {!currentUser ? (
